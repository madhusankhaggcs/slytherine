...
import { AiOutlineArrowRight, AiFillCaretDown} from "react-icons/ai";
    ...
    return(
        ...
        <div className="navbar-container">
            <div className="navbar-left-section">
                <Link to="/" className="navbar-menu-item" style={{color:'black'}}><div className="navbar-logo-section">eMaster</div></Link>
                ...
                {showInput ? (  //true 
                                                    ...
                                                    <div className="navbar-gradelist-sub-item-content" style={{display:"block"}}>
                                                        ...
                                                        {data.SubContent.map((subitem,id)=>( 
                                                          <Link to="/course_detail">  
                                                            <li className="navbar-gradelist-sub-item final-item" onClick={handleGrade} key={id} style={{color:'black', textDecoration:'none'}}>{subitem}</li>
                                                         </Link>
                                                         ))}
                                                        </ul>
                                                    </div>
                    ...
                    <Link to="/" className="navbar-menu-item">AboutUs</Link>
                </div>
                            
            </div>
            <div className="navbar-cart-section">
                <Link to="/shopping_cart"><li className="navbar-cart-section-item cart"><BsFillCartFill size={22}/></li></Link>
                <Link to="/signin" className="navbar-cart-section-item login">Login <AiOutlineArrowRight size={10}/></Link>
