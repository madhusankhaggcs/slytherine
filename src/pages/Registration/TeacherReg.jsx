        ...
        <div className="home-full-screen">
            ...
            <div className="signin-body">
                <div className="signin-body-form">
                    <h1 className="signin-title">Sign Up <br/><span className="signin-title-start-teach">and Start Teaching</span></h1>
                    <ul>
                        ...
                        <li className="signin-body-form-input-list">
                            <HiClipboard size={20}/>
                            <input type="password" className="signin-username" placeholder="Qualifications"
                             name="qualification"
                             value={qualification}
